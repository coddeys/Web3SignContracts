...
update msg_ model_ =
    case ( msg_, model_ ) of
        ( Msg.Docs msg, Model.Docs params model ) ->
            pages.docs.update params msg model
...
view model_ =
    case model_ of
        ...
        Model.Docs params model ->
            pages.docs.view params model
...
subscriptions model_ =
    case model_ of
        ...
        Model.Docs params model ->
            pages.docs.subscriptions params model
...
pages :
    { docs : Bundle Gen.Params.Docs.Params Pages.Docs.Model Pages.Docs.Msg
    , home_ : Bundle Gen.Params.Home_.Params Pages.Home_.Model Pages.Home_.Msg
    , notFound : Static Gen.Params.NotFound.Params
    }
pages =
    { docs = bundle Pages.Docs.page Model.Docs Msg.Docs
